...
/**
 * Entity class defining the structure of a physical address in the database.
...
public class Adresa {
    ...
    // I configure the primary key to be auto-generated by the database.
    @Id
    ...
    // Block and Apartment can be null, so I use String and Integer (object) to allow nulls.
    @Column(name = "bloc")
    private String bloc;
